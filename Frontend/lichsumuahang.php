                            ...
                            <tbody>
                                ...
                                <tr method="post">
                                    ...
                                    <td class="text-center">
                                        <!-- <button class="btn btn-primary">Đang chờ xác nhận đơn hàng</button> -->
                                        <?php
                                        $String_btn_order = "";
                                        if($rowOrder['status']==1){
                                            $string_status = "Chờ xác nhận";
                                        }elseif($rowOrder['status']==2){
                                            $String_btn_order = "btn btn-sm btn-primary btn_confirm_order_user";
                                            $string_status = "Nhận hàng";
                                        }elseif($rowOrder['status']==3){
                                            $string_status = "Đã nhận hàng";
                                        }
                                        ?>
                                        <span id="<?php echo $rowOrder['o_id'] ?>" style="cursor:pointer" class=" btn_confirm_order_user<?php echo $rowOrder['o_id']?> <?php echo $String_btn_order ?>"><?php echo $string_status ?></span>
                                    </td>
                                </tr>
                                <?php }
